...
export function TransactionHistory() {
  ...
  const getStatusBg = (status: TxStatus) => {
    switch (status) {
      case 'completed': return 'bg-gold-500/10 border-gold-500/20'
  ...
  const openTransaction = (txHash: string) => {
    window.open(`https://explorer.testnet.mantle.xyz/tx/${txHash}`, '_blank')
  }
            ...
            >
              ...
              <div className="text-right">
                <div className={`font-semibold mb-1 ${
                  transaction.type === 'received' ? 'text-gold-400' : 'text-white'
                }`}>
