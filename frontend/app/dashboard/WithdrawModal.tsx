          ...
          <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
            {step === 'form' && (
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  type="submit"
                  disabled={!isValid}
                  className="w-full flex items-center justify-center space-x-2 py-4 bg-gradient-to-r from-gold-600 to-gold-700 hover:from-gold-500 hover:to-gold-600 disabled:from-gray-600 disabled:to-gray-700 text-white font-semibold rounded-xl transition-all duration-200 disabled:cursor-not-allowed"
                >
              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    className="flex-1 py-3 bg-gradient-to-r from-gold-600 to-gold-700 hover:from-gold-500 hover:to-gold-600 text-white font-semibold rounded-lg transition-all duration-200"
                  >
                    Confirm & Send
                  </button>
                </div>
            ...
            {step === 'processing' && (
              <div className="text-center py-8">
                <div className="w-16 h-16 bg-gradient-to-r from-gold-500 to-gold-600 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
