    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          <div className="w-8 h-8 bg-gradient-to-r from-gold-500/20 to-gold-600/20 rounded-lg flex items-center justify-center">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onRegister}
            className="flex items-center space-x-2 px-3 py-2 bg-gradient-to-r from-gold-600 to-gold-700 hover:from-gold-500 hover:to-gold-600 text-white text-sm font-medium rounded-lg transition-all duration-200"
          >
        ...
        {loading ? (
          ...
          <div className="text-center py-8 border-2 border-dashed border-dark-600 rounded-xl">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={onRegister}
              className="px-4 py-2 bg-gold-600 hover:bg-gold-500 text-white font-medium rounded-lg transition-colors"
            >
              Add Identifier
            </motion.button>
          </div>
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        ...
                        {identifier.isDefault && (
                          <span className="px-2 py-1 bg-gold-500/20 text-gold-300 text-xs font-medium rounded-full border border-gold-500/30">
                            Default
                          </span>
                        )}
                      </div>
      ...
      <div className="bg-dark-700/30 rounded-lg p-4 border border-dark-600/50 mb-6">
        ...
        {identifiers.length === 0 ? (
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              <label htmlFor="pay-link" className="text-sm text-gray-400">Pay Link</label>
              <input
                id="pay-link"
                readOnly
