      ...
      <div className="w-full max-w-md bg-dark-800 border border-dark-600 rounded-2xl p-6">
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={onPay}
            disabled={loading}
            className="w-full flex items-center justify-center space-x-2 py-3 bg-gradient-to-r from-gold-600 to-gold-700 hover:from-gold-500 hover:to-gold-600 text-white font-semibold rounded-lg transition-all"
          >
