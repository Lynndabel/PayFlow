...
const steps = [
  ...
  },
  {
    ...
    description: 'Deploy your personal smart contract wallet that will handle all your crypto payments and identifier registrations.',
    icon: UserPlus,
    details: [
  ...
  },
  {
    ...
    description: 'Link your phone number or create a username to make yourself discoverable to friends and family.',
    icon: Smartphone,
    details: [
...
const faqs = [
  {
    ...
    answer: 'First, you deploy a smart wallet contract. Then, when you register your phone number, it gets linked to your smart wallet address in our smart contract. When someone sends money to your phone number, our system automatically routes it to your smart wallet.'
  },
  {
    question: 'Do I need a smart wallet to use this service?',
    answer: 'Yes, you must deploy a smart wallet contract first before you can register phone numbers or usernames. This smart wallet handles all your transactions and identifier registrations securely.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes! You can register up to 5 different identifiers (phone numbers or usernames) per smart wallet, giving you maximum flexibility.'
  },
  {
...
export default function HowItWorks() {
  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20 lg:py-32 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              <span className="inline-block px-4 py-2 bg-gold-500/10 border border-gold-500/20 rounded-full text-gold-300 text-sm font-medium mb-4">
                How It Works
              </span>
              ...
              <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Learn how PayFlow revolutionizes crypto payments with phone number transactions. 
                First deploy your smart wallet, then register identifiers to start flowing crypto instantly.
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Setting up your smart wallet and registering identifiers takes less than 5 minutes. Follow our step-by-step guide 
                ...
                >
                  ...
                  <div className="flex-1 max-w-md">
                    <div className="relative">
                      ...
                      {/* Floating elements */}
                      <motion.div
                        className="absolute -top-4 -right-4 w-8 h-8 bg-gold-500/20 rounded-full"
                        animate={{ y: [-10, 10, -10] }}
                        transition={{ duration: 3, repeat: Infinity }}
                      />
                      <motion.div
                        className="absolute -bottom-4 -left-4 w-6 h-6 bg-gold-500/20 rounded-full"
                        animate={{ y: [10, -10, 10] }}
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                  className="group p-8 bg-dark-800/50 backdrop-blur-xl border border-dark-600 rounded-2xl hover:border-gold-500/30 transition-all duration-300"
                >
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <p className="text-xl text-gray-300">
                Everything you need to know about PayFlow and phone number payments.
              </p>
            </motion.div>
          </div>
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-dark-800/50 backdrop-blur-xl border border-dark-600 rounded-2xl p-8 hover:border-gold-500/30 transition-all duration-300"
              >
      ...
      {/* CTA Section */}
      <section className="py-20 lg:py-32 relative">
        <div className="absolute inset-0 bg-gradient-to-r from-gold-500/10 to-gold-600/10" />
